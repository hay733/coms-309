...
public class WeatherActivity extends Activity implements OnClickListener {
    ...
    /**
     * displays text/messages on the weather page
     */
     ...
     *
     * @param v
     * uses cases to call different methods for json
     *      * requests when a specific button is pressed
     */
    @Override
